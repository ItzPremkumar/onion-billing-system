...
if(isset($_POST['save'])){
    ...
    $query = "INSERT INTO party(name, address, mobile_no)
...
<html>
<head>
<title>Onion Party Management</title>
...
<h2 class="title text-center mb-4">🏢 Onion Party Management</h2>
...
<!-- PARTY TABLE -->
<h4 class="mb-3" style="color:#ff7043;">Party List</h4>
...
<?php
$result = pg_query($conn, "SELECT * FROM party ORDER BY party_id DESC");
